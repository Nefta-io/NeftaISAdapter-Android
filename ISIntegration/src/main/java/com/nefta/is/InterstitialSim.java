...
public class InterstitialSim extends TableLayout {
    ...
    private void GetInsightsAndLoad(AdRequest request) {
        ...
        NeftaPlugin._instance.GetInsights(Insights.INTERSTITIAL, request._insight, (Insights insights) -> {
            ...
            if (insights._interstitial != null) {
                ...
                request._interstitial = new SLevelPlayInterstitialAd(request._adUnitId, config);
                request._interstitial.setListener(request);

                NeftaCustomAdapter.OnExternalMediationRequest(request._interstitial._i, request._insight);
    ...
    private void LoadDefault(AdRequest request) {
        ...
        request._interstitial = new SLevelPlayInterstitialAd(request._adUnitId);
        request._interstitial.setListener(request);

        NeftaCustomAdapter.OnExternalMediationRequest(request._interstitial._i);
    ...
    private class SLevelPlayInterstitialAd {
        public String _adUnitId;
        public LevelPlayInterstitialAd _i;
        public LevelPlayAdInfo _adInfo;
        public double _floor = -1;
        public LevelPlayInterstitialAdListener _listener;
        public LevelPlayImpressionData _impressionData;

        public SLevelPlayInterstitialAd(String adUnitId) {
            this(adUnitId, null);
        }

        public SLevelPlayInterstitialAd(String adUnitId, LevelPlayInterstitialAd.Config config) {
            _adUnitId = adUnitId;

            _i = new LevelPlayInterstitialAd(adUnitId);
    ...
    private void SimOnAdLoadedEvent(AdRequest request, boolean isHigh) {
        ...
        LevelPlayAdInfo adInfo = new LevelPlayAdInfo(
                request._interstitial._i.getAdId(),
                request._adUnitId,
                adFormat,
    ...
    private void SimOnAdFailedEvent(AdRequest request, int status) {
        ...
        LevelPlayAdError error = new LevelPlayAdError(request._interstitial._i.getAdId(), request._adUnitId, errorCode, "error");
